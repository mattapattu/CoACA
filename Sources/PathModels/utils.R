...
plotThetaHat2=function(ratdata,testData,res.dir,plot.dir)
{
  ...
  for (i in 1:length(models))
  {
    ...
    plot(rowEnd, alpha,type='l',ylim = c(0,0.4),col='black', ylab = "Parameter value",xlab="Trials", main=models[i],lty=1,lwd=1,cex.axis = 1.5, cex.lab = 1.3)
    lines(rowEnd, gamma1,type='l',col='red',lty=1,lwd=1)
 ...
 #layout( matrix(c(1,0,1,0),ncol=2,nrow=2), heights=c(1,0.2) )
  ...
  for(m in models)
  {
    ...
    #gamma1 = gamma1/denom
     ...
     plot(xaxis,alpha_upper_bounds,type ='l',lty=2,col="black",ylim=c(0,0.1),main=title,xlab="Trials",ylab="Parameters",cex.axis = 1.5, cex.lab = 1.3)
