...
edge17 = new("Edge", edge = c("a2bcd", "a2bcd"), prob = 0.333)
...
edgeListS0 = list(edge1,edge2,edge3,edge4,edge5,edge6,edge7,edge8,edge9,edge10,edge11,edge12,edge13,edge14,edge15,edge16);
