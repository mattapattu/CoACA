...
edge21 = new("Edge", edge = c("c2h", "I"), prob = 1)
edge22 = new("Edge", edge = c("c2d", "E"), prob = 1)

edgeListS0 = list(edge1,edge2,edge3,edge4,edge5,edge6,edge11,edge12,edge13,edge14,edge15,edge16,edge17,edge18,edge19,edge20,edge21,edge22);
