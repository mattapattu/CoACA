...
getRealDataStats=function(ratdata,data.dir,testSuite)
{
  ...
  #print(file)
  ggsave(paste0("boxplotLearningProbs",ratName,".jpg"), p4, path = res.data.dir, width=10,height=7)
  ...
  #print(file)
  ggsave(paste0("boxplotPostLearningProbs",ratName,".jpg"), p5, path = res.data.dir, width=10,height=7)
  ...
  #print(file)
  ggsave(paste0("boxplotAllProbs",ratName,".jpg"), p5, path = res.data.dir, width=10,height=7)
